    ...
    <div>
      ...
      <div className="relative flex flex-col items-center max-w-[1400px] w-[80%] min-h-screen pt-6 mx-auto overflow-x-hidden">
        ...
        <div className="relative flex flex-row items-center justify-center ">
          <div className="w-[100%] mt-[20px] gap-5 flex flex-column flex-wrap items-center justify-center">
        
              <div className="w-[100%]"> 
              <p className="text-[34px] w-[100%] text-white font-bold" style={{fontFamily:"Gilroy black"}}>Swap like you mean it</p>
